...
from app.routers.queue_operations import router as queue_router
from app.websocket import manager
from app.database import init_database
import uvicorn

app = FastAPI(title="Queue Management API", description="Professional API untuk sistem antrian dengan modular structure", version="1.0.0")
